...
{{/* Common labels. */}}
{{- define "keyflow.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version }}
app.kubernetes.io/name: {{ include "keyflow.name" . }}
...
{{- define "keyflow.selectorLabels" -}}
app.kubernetes.io/name: {{ include "keyflow.name" .ctx }}
