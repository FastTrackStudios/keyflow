...
//!
//! Keyflow owns these outright. They used to be re-exported from
//! `daw-proto`, which put the definition of a time signature in the DAW
//! platform and made the notation domain depend upward on it to say what
//! 4/4 means. Keyflow is the authority on understanding a piece of music,
//! so the primitives live here and the DAW reads them from us.
...
/// Compatibility extensions for the time primitives
mod compat {
    use super::*;
